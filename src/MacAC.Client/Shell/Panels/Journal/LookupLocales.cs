...
public readonly record struct LookupLocale(int X, int Y, int Width, int Height, string Name);

public static class LookupLocales
{
    public static readonly LookupLocale[] All =
    [
