...
public enum FeedAct
{
    ...
    /// <summary>F1 toggles entire DebugPanel visibility (macac-only).</summary>
    EngineToggleDebugPanel,
    EngineToggleCollisionWires,
    EngineDumpNearby,
    EngineCycleTimeOfDay,
    EngineSensitivityDown,
    EngineSensitivityUp,
    EngineCycleWeather,
    EngineToggleAudioMute,
    EngineToggleFlyMode,
    EngineTogglePlayerMode,
    EngineRmbOrbitHold,
    EngineFlyDown,
