...
public static partial class CanonDirectiveHelpChart
{
    ...
    public const string HelpStemNote =
        "\nNote: You may substitute a forward slash (/) for the at symbol (@).\n\n";

    public const string ForMoreInformationStem =
    ...
    public const string AllegianceWarningStroke =
    ...
    private const string LanesClusterSummary =
        "@help channels - How to communicate with people in your allegiance or fellowship.";

    private const string ChattingClusterSummaryVerbatim =
        "@help chatting - How to chat publically and privately.";

    private const string DirectivesClusterSummary =
        "@help commands - Lists all commands.";

    public const string DeathClusterSpecifics =
    ...
    public const string ConditionClusterSpecifics =
    ...
    public const string PhraseClusterSpecifics =
    ...
    public const string AllegiancesClusterSpecifics =
        "@allegiance - Commands to help manage your allegiance.\n"
        + "@allegiance motd - Displays or sets the message of the day for your allegiance, see @help motd for more information.\n";

    public const string AllegianceAirStroke = "@a - Sends a broadcast to your Allegiance.\n";
    public const string CovassalAirStroke = "@c - Sends a broadcast to your Co-vassals.\n";
    public const string MonarchAirStroke = "@m - Sends a broadcast to your Monarch.\n";
    public const string PatronAirStroke = "@p - Sends a broadcast to your Patron.\n";
    public const string VassalAirStroke = "@v - Sends a broadcast to your Vassals.\n";
    public const string FellowshipAirStroke = "@f - Sends a broadcast to your Fellowship.\n";

    public const string LanesClusterSpecifics =
        AllegianceAirStroke
        + CovassalAirStroke
        + MonarchAirStroke
        + PatronAirStroke
    ...
    public const string ReplySummaryStroke = "@reply - Sends some text to the last person who @tell'd you.\n";
    public const string PatronReplySummaryStroke = "@pr - Sends some text to the last person who @p'd you.\n";
    public const string MonarchReplySummaryStroke = "@mr - Sends some text to the last person who @m'd you.\n";

    public const string ChattingClusterSpecifics =
        "@chat - Sets whether or not you receive normal chat.\n"
        + "@notell - Sets whether or not you receive @tell's.\n"
        + ReplySummaryStroke
        + PatronReplySummaryStroke
        + MonarchReplySummaryStroke
    ...
    public const string PopulateCompsShortSummary = "@fillcomps - Helps you buy components in bulk.\n";
    public const string PersistWidgetShortSummary = "@saveui <filename> - Saves the current user interface.\n";
    public const string PullWidgetShortSummary = "@loadui <filename> - Loads a previously saved user interface.\n";
    public const string FriendsShortSummary = "@friends - Helps you manage your friends list.\n";
    public const string SquelchClusterShortSummary =
    ...
    public const string DirectivesClusterSpecifics =
        AllegiancesClusterSpecifics
        + LanesClusterSpecifics
        + ChattingClusterSpecifics
        + DeathClusterSpecifics
        + EmoteAndEmotesShortSummary
        + PopulateCompsShortSummary
        + PersistWidgetShortSummary
        + PullWidgetShortSummary
        + PersistWidgetShortSummary
        + PullWidgetShortSummary
        + LockWidgetSpecifics
        + FriendsShortSummary
        + HouseOneLiner
        + SquelchClusterShortSummary
        + ConditionClusterSpecifics
        + PhraseClusterSpecifics;

    public const string OnHandHelpListing =
        "Available help:\n"
        + "@help allegiances - Commands to help you deal with your Allegiance.\n"
        + LanesClusterSummary + "\n"
        + ChattingClusterSummaryVerbatim + "\n"
        ...
        + DirectivesClusterSummary + "\n";

    public const string LifestoneSpecifics =
        "@lifestone - Returns you to the last lifestone you used without killing you.\n";

    public const string MarketplaceSpecifics =
        "@marketplace - Teleports you to the Marketplace of Dereth.\n";

    public const string PkArenaSpecifics =
        "@pkarena - Teleports you to the PK Arena. You must be PK to use this command.\n";

    public const string PkLiteArenaSpecifics =
        "@pklarena - Teleports you to the PKL Arena. You must be PKL to use this command.\n";

    public const string PkLiteSpecifics =
    ...
    public const string AgeSpecifics =
        "@age - Displays your total gameplay time.\n";

    public const string BirthSpecifics =
        "@birth - Displays when your character was created.\n";

    public const string CycleRateSpecifics =
        "@framerate - Toggles the framerate display.\n";

    public const string LockWidgetSpecifics =
        "@lockui - Toggles the locked state of the UI layout.\n";

    public const string VerSpecifics =
        "@version - Tells you what version of the software you are using.\n";

    public const string LocSpecifics =
        "@loc - Displays your current position in your chat window. Use this information when you wish to submit a bug report.\n";

    public const string CorpseSpecifics =
    ...
    public const string PerishSpecifics =
    ...
    public const string WipeSpecifics =
        "@clear - Clears the chat box of all text.\n";

    public const string PersistWidgetSpecifics =
    ...
    public const string ConsentSpecifics =
    ...
    public const string EmoteSpecifics =
    ...
    public const string EmoteRosterSpecifics =
    ...
    public const string FriendsSpecifics =
    ...
    public const string SquelchSpecifics =
    ...
    public const string SiftSpecifics =
    ...
    public const string UnfilterSpecifics =
    ...
    public const string PopulateCompsSpecifics =
    ...
    public const string EnduranceSpecifics =
    ...
    public const string SpeakerSpecifics =
        "@speaker - No longer used, see @allegiance officer for a similar command.\n";

    public const string BannerSpecifics =
        "@title <new title> - Sets the title of the popup chat window.\n";

    public const string CommsFlipSpecifics =
    ...
    public const string HslistSpecifics =
